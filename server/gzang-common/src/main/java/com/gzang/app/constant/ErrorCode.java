...
public final class ErrorCode {
     ...
     * 菜单不存在
     */
    public static final Integer MENU_NOT_FOUND = 3101;

    /**
     * 菜单编码已存在
     */
    public static final Integer MENU_CODE_EXISTS = 3102;

    /**
     * 菜单存在子菜单
     */
    public static final Integer MENU_HAS_CHILDREN = 3103;

    /**
     * 无法删除系统内置菜单
     */
    public static final Integer CANNOT_DELETE_SYSTEM_MENU = 3104;

    /**
     * 无法修改系统内置菜单
     */
    public static final Integer CANNOT_MODIFY_SYSTEM_MENU = 3105;

    /**
     * 父菜单无效
     */
    public static final Integer INVALID_MENU_PARENT = 3106;
