...
public class ReportServiceImpl implements ReportService {
    ...
    public List<MonthlyTrendData> getMonthlyTrend(Long userId, Long companyId, Integer year) {
        List<MonthlyTrendData> trendData = transactionMapper.selectMonthlyTrend(userId, companyId, year);
    ...
    public List<YearlyComparisonData> getYearlyComparison(Long userId, Long companyId, List<Integer> years) {
        ...
        for (Integer year : years) {
            YearlyComparisonData data = transactionMapper.selectYearlyComparison(userId, companyId, year);
            data.setYear(year);
