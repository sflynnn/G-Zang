...
const envConfig: EnvConfig = {
  ...
  APP_NAME: 'G-Zang',
  APP_VERSION: '1.0.0',
  APP_ENV: (import.meta.env.MODE as 'development' | 'production' | 'test') || 'development',

  // 第三方服务配置
  WECHAT_APPID: import.meta.env.VITE_WECHAT_APPID,
  ALIPAY_APPID: import.meta.env.VITE_ALIPAY_APPID,
